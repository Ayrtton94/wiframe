...
const props = defineProps<{
    supplier: {
        ...
        bank_city: string;
        bank_country: string;
        bank_cod_swift: string;
        bank_name2: string | null;
        bank_address2: string | null;
        bank_cod_swift2: string | null;
        others: string | null;
    };
}>();
...
const form = useForm({
    ...
    cod_swift: props.supplier.cod_swift,
    bank_name: props.supplier.bank_name,
    bank_address: props.supplier.bank_address,
    bank_city: props.supplier.bank_city,
    bank_country: props.supplier.bank_country,
    bank_cod_swift: props.supplier.bank_cod_swift,
    bank_name2: props.supplier.bank_name2,
    bank_address2: props.supplier.bank_address2,
    bank_cod_swift2: props.supplier.bank_cod_swift2,
    others: props.supplier.others,
});
...
<template>
    <Head :title="props.supplier ? 'Editar Proveedor' : 'Crear Proveedor'" />
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="flex justify-end gap-3 pt-6">
                    ...
                    <Button type="submit" class="inline-flex items-center px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors shadow-sm hover:shadow-md" :disabled="form.processing">
                        {{ form.processing ? (props.supplier ? 'Actualizando...' : 'Guardando...') : (props.supplier ? 'Actualizar Proveedor' : 'Guardar Proveedor') }}
                    </Button>
                </div>
            </form>
        </div>
